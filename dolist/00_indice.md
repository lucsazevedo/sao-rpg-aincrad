...
|---|---|---|---|
| 1 | [Domador → Criador (pets = craft com raridade)](01_domador_criador.md) | **M** | Move já desenhada (`Domador.png`); pet segue a mesma régua de raridade→efeito que qualquer craft já usa |
| 2 | [3 ataques por arma + Limit Breaker](02_ataques_limit_breaker.md) | **G** | 23 armas × 3 golpes = 69 movesets novos pra desenhar, mais o contador de carga |
| 3 | [Itens/crafts novos](03_itens_crafts_novos.md) | **P–M** | Depende do volume — preciso ver o material antes de fechar número |
| 4 | [Biomas/monstros até andar 50](04_biomas_monstros_andar50.md) | **P (roster) / GG (ficha completa)** | As imagens já têm nome+drop; virar ficha jogável de cada um é o projeto dos próximos andares, não uma tarefa |
| 5 | [Sistema de Níveis e XP](05_niveis_e_xp.md) | **M** | Precisa decidir se substitui ou convive com Marcos (regra atual: "não existe XP por matar") |
| 6 | [Jogo online diário (missões, desbloqueio, mercado)](06_jogo_online_diario.md) | **GG** | É o projeto principal — os itens 5, 7, 8, 9 e 10 são pedaços dele, não itens paralelos |
| 7 | [Drops estilo MMO (equipável/consumível/carta)](07_drops_e_cartas.md) | **M–G** | Mecânica é simples; o trabalho real é o volume de conteúdo, e cresce junto com o item 4 |
...
Ver cada arquivo — cada um tem uma seção "Preciso saber" no final.
