...
Anéis, colares, broches, ferramentas de ofício penduradas no cinto. É o slot
mais denso do catálogo de propósito: é aqui que as profissões que não são
"crafting clássico" (Diplomata, Coveiro, Músico, Cartógrafo, Comerciante,
Bibliotecário) ganham peça própria, pra não ficarem sem gancho mecânico
enquanto Ferreiro e Alquimista transbordam de conteúdo.

Um personagem pode equipar **dois** acessórios ao mesmo tempo — mas o teto de
+1 por teste continua valendo (`equipamentos/00_indice.md`).

---

## Cordão de Contas de Argila — Comum
**Requisito:** — · **Preço base:** 40 Col

Contas de argila do barranco do Rio Coluber, queimadas mal e mal, num cordão
de linha de pesca. Metade dos jogadores novos faz um.

**Efeito:** nenhum bônus. **Utilidade:** as contas podem ser destacadas uma a
uma como marcadores — serve de contador físico de mesa (rodadas, sucessos de
doma, tentativas de puzzle). Alguns grupos usam pra registrar mortos.

**Como obter:** crafting de Joalheiro (Argila); vendido por 5 Col em qualquer
banca.

---

## Anel de Escama Prateada — Incomum
**Requisito:** — · **Preço base:** 300 Col
...
comprado em Tolbana) — receita já documentada em
...
falha; o mestre precisa achar outro preço a cobrar.

**Como obter:** Comerciante da Estrada de Ombric; recompensa de
`bounty_04_vista_do_topo`.
...
**Como obter:** vendida em Tolbana (cadeia E); o Mercado Negro da Cidade do
Início tem uma versão adulterada por 120 Col que mostra a raridade errada
uma vez em cada três — e não avisa qual vez.
...
**Como obter:** concedido na cadeia E (`Vida em Tolbana`) a quem resolver uma
disputa entre duas guildas sem que ninguém saque arma. Os dois sulcos vazios
são conteúdo em aberto de propósito.
...
próprio usuário, e isso é regra, não sabor.
...
**Como obter:** do busker da Taverna da Cidade do Início, depois que ele
ensinar a cantiga do puzzle do mural (`castelo_01_cantiga_do_musico`). Ele
diz que já não afina mais.
...
**Efeito:** nenhum bônus numérico. **Utilidade:** o **Bibliotecário** pode
manter **duas pesquisas em aberto** ao mesmo tempo na Torre de Aldric em vez
de uma — o que significa chegar a um combate sabendo a fraqueza de dois
monstros diferentes.

**Como obter:** Estudioso Obcecado, de graça, na segunda conversa. Ele
insiste que é um empréstimo.

---

## Frasco Vazio Lacrado — Comum
**Requisito:** — · **Preço base:** 60 Col (lote de 3)

Vidro grosso com rolha de cera. O item mais chato e mais necessário do
andar — toda receita de Alquimista morre sem ele.

**Efeito:** nenhum bônus. **Utilidade:** permite guardar uma dose de qualquer
líquido coletado no campo (Seiva de Nepenthes, água do redemoinho do Lago
Sylvaine, veneno de Rã) sem contaminar. Sem frasco, o material se perde na
volta pra cidade, e isso deve ser cobrado.

**Como obter:** Comerciante da Cidade do Início ou de Tolbana. Importado —
não existe fonte local, e é por isso que o Comerciante importa.

---

## Presa de Javali Engastada — Comum
**Requisito:** — · **Preço base:** 80 Col

Uma presa de Frenzy Boar limpa e presa a um cordão de couro. Praticamente um
troféu de primeira caçada — quase todo personagem de andar 1 tem ou teve um.

**Efeito:** nenhum bônus. **Utilidade social:** identifica o usuário como
alguém que já saiu dos muros. NPCs de campo (Erik, Fazendeiro Local,
caçadores de Horunka) começam a conversa um degrau mais receptivos.

**Como obter:** crafting de Joalheiro (Presa de Javali); ou simplesmente
furar uma presa com uma faca, o que qualquer personagem pode fazer sem teste.

---

## Amuleto de Cristal Bruto — Incomum
**Requisito:** — · **Preço base:** 350 Col

Lasca de Cristal Bruto da Gruta de Lumis presa numa gaiola de arame. Não é um
...
usá-lo pra puxar o grupo até baús que passariam batido.

**Como obter:** crafting de Joalheiro (Cristal Bruto + fio de prata); a
Gruta de Lumis é a única fonte confiável do cristal.
...
a mesma cantiga do busker da Taverna. Sempre no mesmo trecho. Sempre parando
antes do último verso.
**Aviso ao mestre:** este item é um fio do mistério do andar 2
(`docs/misterio_andar2.md`), não a resposta. Ele deve levantar mais perguntas
a cada uso, nunca fechar nenhuma.

**Como obter:** resolver o puzzle do mural dos 5 cristais no Castelo de Ferro
Negro (`docs/interacoes_e_segredos.md`, cadeia G) e entrar na Câmara da
Inscrição. Está na câmara, no chão, como se alguém tivesse deixado cair
saindo com pressa.
