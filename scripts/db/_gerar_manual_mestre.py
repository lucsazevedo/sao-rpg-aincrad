# -*- coding: utf-8 -*-
"""
Gera o Manual do Mestre (scripts/db/_manual_mestre_template.html +
conteúdo vivo do banco). Rode _extrair_conteudo_livro.py antes.

Rode: python scripts/db/_gerar_manual_mestre.py <saida.html>
"""
import os
import sys
...
with open(os.path.join(AQUI, "_manual_mestre_template.html"), encoding="utf-8") as f:
    template = f.read()
...
destino = sys.argv[1] if len(sys.argv) > 1 else os.path.join(RAIZ, "scripts", "_manual_mestre.html")
