-- Item 14 do dolist (Ferramentas de ofício — bônus de sucesso em craft).
-- craftar_item/craftar_ferramenta já tinham comentário dizendo "+ bônus de
-- ferramenta de ofício se equipada" mas nunca implementavam de verdade —
-- ferramenta era só colecionável. Agora soma o maior bonus_acao entre as
-- ferramentas que o personagem tem pra aquela profissão, direto no mod do
-- 2d6 (escala PBTA pequena, não percentual — ajustei os 4 registros de
-- Incubadora do Domador de "+3%/+6%/+12%/+15%" pra "+1/+1/+2/+3" no teste,
-- consistente com o resto do jogo online, que já usa mod de -3 a +3).
