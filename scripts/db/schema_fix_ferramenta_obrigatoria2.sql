-- Item 16 parte 1 continuação — enforcement de requer_ferramenta_id nas
-- duas RPCs de craft (opcional por receita, sem mudar comportamento de
-- quem ainda não tem ferramenta associada).
