---
titulo: Catálogo de Receitas — Alquimista
andar: 1
receitas: 17
---
...
**Isso não duplica os Cristais do sistema.** `docs/mercado_andar1.md` já
vende Cristal de Cura, Antídoto, Barreira, Luz e Teleporte — objetos de
sistema, comprados prontos, sem craft. As receitas daqui são **poções e
unguentos do Alquimista**: só existem se alguém craftar, não têm reposição
automática de loja, e por isso custam a metade ou menos do Cristal
equivalente (é a vantagem competitiva da profissão, já registrada em
`docs/mercado_andar1.md`: "antídoto 250 Col contra 250 do Cristal — e o seu
não tem recarga").
...
uma cena inteira de exploração.
...
Condição formal — é conforto, evita que a cena piore por causa disso).
...
em viagem — resolve o problema que o `Cristal Bruto` tem de degradar.
...
função) sem dizer qual — o mesmo que a `Balança de Bolso`, versão líquida e
descartável.
**Como conseguir:** Cristal Bruto, 70 Col no mercado, ou achado na Gruta de
Lumis.
...
Recuperação" abstrato já descrito em `docs/producao_por_oficio.md`, agora
com nome e ficha.
...
**Como conseguir:** Ossos Antigos, 14 Col no mercado ou coletados na
Necrópole de Voss (com respeito — ver Coveiro em `oficios_andar1.md`).
...
**Efeito:** remove **qualquer** status negativo (veneno, paralisia, sono,
confusão, amedrontado) de uma vez, sem gastar Cristal nenhum.
**Como conseguir:** o "veneno de chefe" vem de qualquer miniboss ou chefe
...
**Efeito:** o jogador escolhe **um** atributo; ele recebe vantagem em todo
teste durante a cena inteira — a versão em poção do "Sabor da Vitória" do
Cozinheiro (`Comidas/00_catalogo_receitas_cozinheiro.md`). As duas nunca
empilham na mesma cena — é escolha de qual profissão brilha.
...
**Efeito:** uma vez por sessão, quando **qualquer** aliado seria derrotado,
quem bebeu o elixir antes da cena troca de lugar com ele — mesma mecânica
do `Escudo e Espada do Primeiro Muro` (`armas/00_catalogo_expandido.md`),
só que é consumível, não equipamento, e **precisa ser bebido antes da
cena começar** — não dá pra reagir na hora.
...
**Efeito:** durante a cena, todo o grupo reduz em 1 o impacto do primeiro
golpe que cada um receber — defesa coletiva, não individual.
**Como conseguir:** Olho Leitoso, `monstros/guardiao_de_mournhall.md`
(Incomum, 25% de chance, 1 unidade) — já é o material que a tabela de
drop reserva pro Alquimista, sem concorrer com Ferreiro, Cozinheiro ou
Coveiro.

---

# Insumos novos — preço de referência

Itens que este catálogo usa e ainda não tinham linha em
`docs/mercado_andar1.md`:

| Item | Col |
|---|---|
| Carvão (unidade) | 10 |
| Água Pura / Água Limpa | grátis fora de zona contaminada |
| Erva Vital | 18 |
| Erva Ancestral | 30 (só na Necrópole de Voss ou Torre de Aldric) |

O resto (Seiva de Nepenthes, Musgo Luminoso, Pó Dourado, Néctar de Flor
Rara, Ferrão de Vespa, Ossos Antigos, Cristal Bruto) já tem preço fixado na
"Tabela de compra de materiais" de `docs/mercado_andar1.md` — usados aqui
sem alteração.
